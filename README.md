...
This docker container is cloned from https://github.com/sprintcube/docker-compose-lamp, customized to host my project.
...
Though the localhost webpage also offers a link to do the same job, however, web interface seems to have a little problem.
I'd debug it if I had more time. The command line way always works.
